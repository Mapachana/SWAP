...
\date{\today}
\title{Práctica 2: Clonar la información de un sitio web}
...
\item \href{https://linux.die.net/man/1/rsync}{https://linux.die.net/man/1/rsync}
\item \href{https://linux.die.net/man/1/scp}{https://linux.die.net/man/1/scp}
\item \href{https://crontab.guru/}{https://crontab.guru/}
\end{itemize}
